...
o	sudo apt install python3.12-venv
...
o	The hostname should be the public IPv4 address
o	User is just ubuntu or similar
o	IdentityFile is where you specify the .pem to use and its path
